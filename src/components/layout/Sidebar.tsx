...
import {
  LayoutDashboard, FileCode2, Users, Hammer, Zap,
  ChevronRight, Globe, MessageCircle, Inbox, Search,
  KanbanSquare, Layers,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/smart-bulk",  label: "Smart Bulk",  icon: Layers,          badge: "⚡",   badgeColor: "bg-brand-100 text-brand-700" },
  ...
  { href: "/crm",        label: "CRM",         icon: KanbanSquare,    badge: "NEW",  badgeColor: "bg-brand-100 text-brand-700" },
        ...
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="text-sm font-bold text-slate-900 tracking-tight">
              Build<span className="text-brand-600">Factory</span>
            </span>
      ...
      <div className="px-4 py-4 border-t border-surface-100">
        <div className="bg-brand-50 rounded-xl p-3 border border-brand-100">
          ...
          <p className="text-[10px] text-brand-500 leading-relaxed">
            Bulk website generation & deployment
          </p>
        </div>
      </div>
    </aside>
